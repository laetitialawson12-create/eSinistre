...
urlpatterns = [
    ...
    path('admin/sinistres/importer/', views.importer_sinistres_admin, name='importer_sinistres'),
    path('admin/sinistres/exporter/', views.exporter_sinistres_admin, name='exporter_sinistres'),
    path('admin/sinistres/action-lot/', views.action_lot_sinistres, name='action_lot_sinistres'),
