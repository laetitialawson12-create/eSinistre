...
class SinistreForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'vehicule_adverse_categorie': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Modèle'}),
...
class DeclarationTiersForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'vehicule_adverse_categorie', 'vehicule_adverse_compagnie', 'nombre_blesses', 'nombre_morts',
            'lettre_derogation',
        ]
        widgets = {
            ...
            'vehicule_adverse_categorie': forms.TextInput(attrs={'class': 'form-control'}),
